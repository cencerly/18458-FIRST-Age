...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -7846.414158824137; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -10743.66083939347; // x position of the perpendicular encoder (in tick units)
    }
